...
salary decimal(10,2)
    ...
    private static void createRecord() {
        String query = "INSERT INTO employees (first_name, last_name, email, hire_date) VALUES (?, ?, ?, ?)";
        try {
    ...
    private static void deleteRecord() {
        ...
        try {
            preparedStatement = connection.prepareStatement(query);
            preparedStatement.setInt(1, 1);// (snumebr, id: which we want to delete)
            preparedStatement.executeUpdate();
