...
public class HierarchicalCacheTest {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        HierarchicalCache cache = new HierarchicalCache(100, 1000, "C:\\Users\\gites\\IdeaProjects\\caching-project\\src\\main\\java\\usercase2\\productFiles");
