...
public class Cache {
    ...
    public void addRecentMovie(String movieID, String movieName) {
        recentMoviewCache.put(movieID, movieName);
        System.out.println("Added to Recent Movies Cache: " + movieName);
    }

    public void addPopularMovie(String movieID, String movieName) {
        popularMoviewCache.put(movieID, movieName);
        System.out.println("Added to Popular Movies Cache: " + movieName);
    }

    public void printRecentMoviesCache() {
        System.out.println("Recent Movies Cache (L1):");
        for (Map.Entry<String, String> entry : recentMoviewCache.entrySet()) {
            System.out.println("Movie ID: " + entry.getKey() + ", Movie Name: " + entry.getValue());
        }
    }
    ...
    public void main(String[] args)
    {
        ...
        addRecentMovie("M1", "Inception");
        addRecentMovie("M2", "The Dark Knight");
        addRecentMovie("M3", "Interstellar");

        printRecentMoviesCache();
    }
